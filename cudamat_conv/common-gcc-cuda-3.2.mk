...
ROOTBINDIR ?= bin/$(SM_ARCH)
BINDIR     ?= $(ROOTBINDIR)/$(OSLOWER)
ROOTOBJDIR ?= obj/$(SM_ARCH)
...
#$(OBJDIR)/src/TransNetPretrain.cu.o : $(SRCDIR)%.cu $(CU_DEPS)
#	echo asdf
$(OBJDIR)/%.cu.o : $(SRCDIR)%.cu $(CU_DEPS)
	$(VERBOSE)$(NVCC) $(GENCODE_SM13) $(GENCODE_ARCH) $(GENCODE_SM20) $(NVCCFLAGS) $(SMVERSIONFLAGS) -o $@ -c $<

# Default arch includes gencode for sm_10, sm_20, and other archs from GENCODE_ARCH declared in the makefile
$(CUBINDIR)/%.cubin : $(SRCDIR)%.cu cubindirectory
	$(VERBOSE)$(NVCC) $(GENCODE_SM13) $(GENCODE_ARCH) $(GENCODE_SM20) $(CUBIN_ARCH_FLAG) $(NVCCFLAGS) $(SMVERSIONFLAGS) -o $@ -cubin $<
...
#poo:
#	echo $(CU_DEPS)
$(TARGET): makedirectories $(OBJS) $(CUBINS) $(PTXBINS) Makefile link
	$(VERBOSE)$(LINKLINE)

link: 
	$(VERBOSE)ln -sf ./bin/$(SM_ARCH)/linux/release/$(EXECUTABLE) .
