...
_HYPERPARAMS = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='switch_on_sc_alpha_after', full_name='deepnet.Hyperparams.switch_on_sc_alpha_after', index=42,
